...
def customOnMessage(message):
    ...
    if(message.topic == 'test/select'):
        print("in")
        print(message.payload)
        data = message.payload
        print(create_db.select_db(data))
    if(message.topic == 'test/insert'):
        data = message.payload[1:-1].splite(':')
        print(create_db.insert_db(data[0], data[1]))
