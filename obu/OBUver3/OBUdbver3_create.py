...
(71, 85, '37.505', '127.000', '37.501', '126.986'), 
(85, 86, '37.501', '126.986', '37.499', '126.985'), 
...
def create_db() :
    try :
        ...
        # Create OBU table
        cur.execute("CREATE TABLE IF NOT EXISTS OBU (rsu_id INTEGER PRIMARY KEY, obu_id , path TEXT)")
